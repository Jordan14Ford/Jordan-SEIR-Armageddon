...
Every deliverable file, what it proves, category (core / Be A Man / optional), and status. Paths are relative to repo root (Lab2 is under Armageddon).

**Proof files:** Canonical locations only — `Lab2/Lab2A/deliverables/proof/` (2A) and `Lab2/Lab2B/deliverables/proof/` (2B). Not duplicated in `Lab2/deliverables/`; see `proof/README.md` for a short file list.
