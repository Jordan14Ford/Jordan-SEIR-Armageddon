...
# Output folders
# ============================================================
# Run from repo root (Armageddon). Paths relative to repo root.
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
REPO_ROOT="$(cd "$SCRIPT_DIR/../../../../.." && pwd)"
GATE_OUT="$REPO_ROOT/SEIR_Foundations/LAB2/2a/deliverables/verification/gates"
SEIR_PYTHON="$REPO_ROOT/SEIR_Foundations/LAB2/2a/src/python"
mkdir -p "$GATE_OUT"
