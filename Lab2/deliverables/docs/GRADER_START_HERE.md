...
| Order | File | Purpose |
|-------|------|---------|
| 1 | **DELIVERABLES_INDEX.md** (this folder) | Every deliverable file, what it proves, core vs Be A Man vs optional, status (ready/partial/pending). All proof lives under Lab2/Lab2A/deliverables/proof/ and Lab2/Lab2B/deliverables/proof/ (not duplicated here). |
...
Proof and verification files are **not** duplicated in `Lab2/deliverables/`. They live in:

| Content | Path from repo root |
|---------|----------------------|
| **2A proof** (CloudFront 200, DNS, WAF, ALB blocked) | `Lab2/Lab2A/deliverables/proof/` |
| **2B proof** (static cache, API no-cache, public-feed, invalidation, ManC) | `Lab2/Lab2B/deliverables/proof/` |
| **2A verification** (CloudFront, Route53, WAF, ALB listings) | `Lab2/Lab2A/deliverables/verification/` |
| **Gate outputs** (PASS/FAIL runs) | `Lab2/Lab2A/deliverables/verification/gates/` |

Short indexes for proof and gates are in `Lab2/deliverables/proof/README.md` and `Lab2/deliverables/gates/README.md`.

---

## 3. Terraform to submit / reference

All under **Lab2/Lab2A/** (2A and 2B share the same CloudFront stack):
